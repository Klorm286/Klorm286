...
| **Анализ данных о поездках Uber** | Анализ данных о заказах такси, выявление закономерностей, приводящих к неуспешным поездкам, и формулировка рекомендаций для бизнеса по улучшению качества сервиса на основе этих данных.| Python, Pandas, Matplotlib, Seaborn|
| **Анализ продаж и предпочтений клиентов музыкального магазина Chinook**| Выявление самых прибыльных музыкальных жанров, определение географии наиболее активных клиентов и составление портрета типичного покупателя для увеличения выручки. | Python, SQLite3, Pandas, Matplotlib, Seaborn, Tableau |
| **Анализ рынка труда для Data-аналитиков** | Сбор и анализ более 2000 вакансий с hh.ru по API для позиции 'Аналитик данных'. Проект включает в себя очистку данных, извлечение ключевых навыков, геокодирование и визуализацию результатов в интерактивном дашборде. | Python, Pandas, Requests, Geopy, Tableau |
| **Анализ финансовых рисков: Bitcoin vs S&P 500** | Сравнительный анализ волатильности и корреляции активов. Проект включает автоматический ETL-пайплайн, расчет метрик риска (VaR, Max Drawdown) и проверку гипотезы о Биткоине как защитном активе. | Python, Pandas, SQLite3, Yfinance, Matplotlib, Seaborn |
| **Анализ рынка аренды недвижимости Москвы** | Разработка полного ETL-цикла: автоматический скрейпинг объявлений, очистка данных и геокодинг адресов. Проект включает анализ влияния инфраструктуры на цену и визуализацию рынка на интерактивной карте. | Python, Pandas, Selenium, BeautifulSoup4, Geopy, Folium |
